...
function Register() {
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await fetch("http://localhost/DBU-APII/dbu-api/register.php", {
        method: "POST",
        headers: {
  ...
  return (
    <div className="max-w-[350px] mx-auto mt-20 bg-white shadow-lg p-5 rounded-xl text-center font-[Poppins]">
